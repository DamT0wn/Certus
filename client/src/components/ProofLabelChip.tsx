...
> = {
  DOCUMENT_FACT: {
    text: "DOCUMENT FACT",
    shortText: "FACT",
    borderCol: "border-emerald-600/40 dark:border-emerald-500/50",
    textCol: "text-emerald-800 dark:text-emerald-200",
    bgCol: "bg-emerald-50 dark:bg-emerald-950/40",
  ...
  VERIFIED_LAW: {
    text: "VERIFIED LAW",
    shortText: "LAW",
    borderCol: "border-sky-600/40 dark:border-sky-500/50",
    textCol: "text-sky-900 dark:text-sky-200",
    bgCol: "bg-sky-50 dark:bg-sky-950/40",
    description: "Supported by authoritative statutes or established Delaware jurisprudence",
    icon: Scale,
  },
  AI_INFERENCE: {
    text: "AI INFERENCE",
    shortText: "INFERENCE",
    borderCol: "border-amber-600/40 dark:border-amber-500/50",
    textCol: "text-amber-900 dark:text-amber-200",
    bgCol: "bg-amber-50 dark:bg-amber-950/40",
  ...
  UNVERIFIED: {
    ...
    borderCol: "border-rose-600/40 dark:border-rose-500/50",
    textCol: "text-rose-900 dark:text-rose-200",
    bgCol: "bg-rose-50 dark:bg-rose-950/40",
